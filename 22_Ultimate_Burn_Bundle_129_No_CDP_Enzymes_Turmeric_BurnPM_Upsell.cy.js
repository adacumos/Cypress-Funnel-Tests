...
describe('22 New Year Special VIP Sale - V1', () => {
  ...
  it('Verify $129 Ultimate Burn Bundle No CDP, Enzymes, Turmeric & Burn PM Upsell', () => {
    ...
    // Verify Next URL
    cy.VerifyNextURL('sp/burn-evolved/burn-pm-cs-12')
    ...
    // Save Order Details
    // cy.SaveOrderDetails(user, file, 'Burn PM', '1', '288.00', 'physical')

    // --------- Turmeric Upsell ---------

    // Verify Next URL
    cy.VerifyNextURL('sp/burn-evolved/turmeric-cs-12')
    ...
    // Save Order Details
    // cy.SaveOrderDetails(user, file, 'Turmeric Black', '1', '288.00', 'physical')

    // --------- Enzymes Upsell ---------

    // Verify Next URL
    cy.VerifyNextURL('sp/burn-evolved/enzymes-cs-12')
    ...
    // Save Order Details
    // cy.SaveOrderDetails(user, file, 'Enzymes', '1', '288.00', 'physical')
