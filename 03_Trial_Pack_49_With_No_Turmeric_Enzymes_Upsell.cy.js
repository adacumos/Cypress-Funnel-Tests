...
describe('03 New Year Special VIP Sale - V1', () => {
  ...
  it('Verify $49 Trial Pack With NO Turmeric & Enzymes Upsells', () => {
    ...
    // Verify Next URL
    cy.VerifyNextURL('sp/burn/burn-pm-cs-3')
    ...
    // Verify Next URL
    cy.VerifyNextURL('sp/burn/turmeric-cs-3')
    ...
    // Verify Next URL
    cy.VerifyNextURL('sp/burn/enzymes-cs-3')
