...
describe('16 New Year Special VIP Sale - V1', () => {
  ...
  it('Verify $97 Burn Fat Loss Stack No Enzymes & Turmeric Downsell', () => {
    ...
    // Verify Next URL
    cy.VerifyNextURL('sp/burn-evolved/burn-pm-cs-3')
    ...
    // Save Order Details
    cy.SaveOrderDetails(user, file, 'Burn PM', '1', '72.00', 'physical')

    // --------- Turmeric Downsell ---------

    // Verify Next URL
    cy.VerifyNextURL('sp/burn-evolved/turmeric-cs-3')
    ...
    // Save Order Details
    // cy.SaveOrderDetails(user, file, 'Turmeric Black', '1', '72.00', 'physical')

    // --------- Enzymes Downsell ---------

    // Verify Next URL
    cy.VerifyNextURL('sp/burn-evolved/enzymes-cs-3')
    ...
    // Save Order Details
    // cy.SaveOrderDetails(user, file, 'Enzymes', '1', '72.00', 'physical')
